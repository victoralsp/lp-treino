...
document.querySelectorAll('.who-is-animate, .animate-h2, .animate-card, .animate-plan, .animate-step, .animate-fade-up, .animate-slide-left, .animate-fade-in, .animate-slide-right, .animate-faq').forEach(el => {
